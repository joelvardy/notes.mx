...
class NotesController extends ApiController {
    ...
    protected function readNote($id) {
        ...
        if ( ! isset($note) || Input::header('user-id') != $note->user_id) return false;
    ...
    public function destroy($id) {
        ...
        try {
            ...
            return $this->response->respondWithMessage('Note has been deleted');
        } catch (StorageException $e) {
            return $this->response->setStatusCode(400)->respondWithError('Unable to delete note');
        }
