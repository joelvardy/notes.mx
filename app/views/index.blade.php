...
<html lang="en-GB">
	<head>
		...
		<title>Notes</title>
		<link rel="stylesheet" href="{{ $assetPath }}/css/base.css" />
		<link rel="stylesheet" href="{{ $assetPath }}/css/modules.css" />
		<link rel="stylesheet" href="{{ $assetPath }}/css/design.css" />
	...
	<body>
		...
		<script src="{{ $assetPath }}/js/class/loading.js"></script>
		<script src="{{ $assetPath }}/js/class/user.js"></script>
		<script src="{{ $assetPath }}/js/class/storage.js"></script>
		<script src="{{ $assetPath }}/js/class/analytics.js"></script>
		<script src="{{ $assetPath }}/js/class/cryptography.js"></script>
		<script src="{{ $assetPath }}/js/class/note.js"></script>
		<script src="{{ $assetPath }}/js/class/dialogue.js"></script>
		<script src="{{ $assetPath }}/js/class/template.js"></script>
		<script src="{{ $assetPath }}/js/class/route.js"></script>
		<script src="{{ $assetPath }}/js/base.js"></script>
	</body>
</html>
